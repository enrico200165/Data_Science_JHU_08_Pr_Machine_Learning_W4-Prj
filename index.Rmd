...
I chose random forest for which cross validation is not as important as it is for other techniques, so did not perform cross validation with K > 2:  
...
<b>0.32%</b>, estimate provided directly from the model. See appendix.
